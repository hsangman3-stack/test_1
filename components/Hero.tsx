    ...
    <section id="home" className="relative py-20 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 mt-12 md:mt-0 relative">
          <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition duration-500">
            <img 
              src="https://picsum.photos/seed/happy-dog/800/600" 
              alt="Happy dog" 
              className="w-full h-auto object-cover"
            />
          </div>
          <div className="absolute -top-10 -right-10 w-64 h-64 bg-orange-200 rounded-full blur-3xl opacity-50 z-0 animate-pulse"></div>
          <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-yellow-200 rounded-full blur-2xl opacity-50 z-0 animate-bounce"></div>
        </div>
      </div>
    </section>
  );
